...
public class DenoiserStore implements AudioProcessorStore {
    ...
    public DenoiserStore(int fs, double noSpeechDuration) {
        windowLength = 256;
        overlapRatio = 0.5;
        this.fs = fs;
    ...
    public DenoiserStore(int fs, double noSpeechDuration, int noiseLength, int noiseThreshold, int frameReset) {
        windowLength = 256;
        overlapRatio = 0.5;
        this.fs = fs;
        this.noSpeechDuration = noSpeechDuration;
